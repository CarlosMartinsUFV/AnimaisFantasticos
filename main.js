          ...
          function O(t, e) {
            function n(o, i, c, s) {
              ...
              if ("throw" !== u.type) {
                var l = u.arg,
                  h = l.value;
                return h && "object" == r(h) && a.call(h, "__await")
          ...
          function _(t, n, r) {
            ...
            return function (i, a) {
              ...
              for (r.method = i, r.arg = a; ; ) {
                ...
                var u = d(t, n, r);
                if ("normal" === u.type) {
                  if (((o = r.done ? g : y), u.arg === b)) continue;
  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      var a = (function () {
          function e(n, r) {
            t(this, e),
              ...
              (this.options =
                void 0 === r ? { behavior: "smooth", block: "start" } : r),
        ...
        u = (function () {
          function e(n, r, o) {
            t(this, e),
              ...
              (this.botaoFechar = document.querySelector(r)),
        ...
        x = (function () {
          function e(n, r, o) {
            t(this, e),
              ...
              (this.observerTarget = document.querySelector(r)),
                  ...
                  value: function (t) {
                    var e = +t.innerText,
                      ...
                      o = setInterval(function () {
                        (r += n),
                          (t.innerText = r),
                          r > e && ((t.innerText = e), clearInterval(o));
                      }, 25 * Math.random());
                  },
                },
              ]
      ...
      new a('[data-menu="suave"] a[href^="#"]').init(),
        new c('[data-anime="accordion"] dt').init(),
        ...
        (function () {
          function t(t) {
            ...
            t.preventDefault(),
              ...
              h(this, ["touchstart", "click"], function () {
        ...
        (d = (v = document.querySelector("[data-semana]")).dataset.semana
          .split(",")
          .map(Number)),
        (p = v.dataset.horario.split(",").map(Number)),
        (m = (y = new Date()).getDay()),
        (g = y.getHours()),
        (b = -1 !== d.indexOf(m)),
        (L = g >= p[0] && g < p[1]),
        b && L && v.classList.add("aberto"),
                      ...
                      switch ((t.prev = t.next)) {
                        ...
                        case 6:
                          t.sent.forEach(function (t) {
                            ...
                            new x("[data-numero]", ".numeros", "ativo").init(),
                            (t.next = 14);
                          break;
                        case 11:
